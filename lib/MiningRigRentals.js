...
class MiningRigRentals {
  ...
  async getTransactions(options) {
		console.log('OPTIONS MININGRIGRENTALS.JS 166', options)
...
const settings = {
  key: '7a0af8a0952ff6a9a3a448959271171ac5b2dd67a8074a7201bb7c2cb6803e8a',
  secret: '7743b142c703558eac289d9a9117694a4984acd04be41e30cdf2a3af00d2c7dc'
}
let miningrigREntals = new MiningRigRentals(settings)
// [credit,payout,referral,deposit,payment,credit/refund,debit/refund,rental fee]
let payment = {
  start: 0,
  limit: 13,
  type: 'payment'
...
//  miningrigREntals.getTransactions(payment)
// .then((data) => {
...
setTimeout(()=>{
  miningrigREntals.getTransactions(debit)
.then((data) => {
  console.log('rentalFee:', data.data)
})
.catch(err => console.log('rentalFee error:', err))
},1000)
